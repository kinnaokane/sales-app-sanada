          ...
          {data.map((record) => (
            <>
              ...
              >
                ...
                <TableCell>{record.products.length}種類</TableCell>
                <TableCell className="text-right">{record.subtotal.toLocaleString()}円</TableCell>
                <TableCell className="text-right">{record.tax.toLocaleString()}円</TableCell>
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow>
                            ...
                            <TableHead className="text-right">小計</TableHead>
                            <TableHead className="text-right">作業時間(分)</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {record.products.map((product) => (
                            <TableRow key={product.id}>
                              ...
                              <TableCell className="text-right">{product.workTime}</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
